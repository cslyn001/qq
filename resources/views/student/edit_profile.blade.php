            ...
            <div class="card">
                <form action="{{ url('student/save-profile') }}" method="POST" enctype="multipart/form-data">
                    ...
                    @endif
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        ...
                                        <div class="image-input image-input-empty image-input-outline" id="prof_pic">
                                            ...
                                            <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change avatar">
                                             ...
                                             <input type="file" name="prof_pic" accept=".png, .jpg, .jpeg" value="{{ isset($row) ? $row->pro_pic : '' }}"/>
                        ...
                        <div class="form-group row">
                                    <label for="fname" class="col-sm-2 col-form-label">Objective</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="objective" name="objective" placeholder="Objective" value="{{ isset($row) ? $row->objective : '' }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="mname" class="col-sm-2 col-form-label">Middle Initial</label>
                                    <div class="col-sm-10">
                                        ...
                                        <select name="province" id="province" class="form-control select2 required" style="width: 100%;">
                                            ...
                                            @if (isset($row))
                                                @foreach ($provinces as $province)
                                                    <option value="{{ $province->province_id }}" {{ $row->province == $province->province_id ? 'selected' : '' }}>{{ $province->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                        ...
                                        <select name="city" id="city" class="form-control select2 required" style="width: 100%;">
                                            ...
                                            @if (isset($row))
                                                @foreach ($cities as $city)
                                                    <option value="{{ $city->city_id }}" {{ $row->city == $city->city_id ? 'selected' : '' }}>{{ $city->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
