                            ...
                            @if (isset($users))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-xs btn-success btnDelUser"  data-value="{{ $item->id }}">
                                        ...
                                        <button class="btn btn-xs btn-warning" data-toggle="modal" data-target="#change">
                                            ...
                                            <button class="btn btn-xs btn-danger btnDelFaculty"  data-value="{{ $item->id }}">
...
<script>
    ...
    $('.btnDelFaculty').on('click', function(){
